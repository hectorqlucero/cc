  ...
  (try
    (let [id       (fix-id (:id params))
          postvars {:id               id
                    ...
                    :nombre           (clojure.string/capitalize (:nombre params))
                    :apellido_paterno (clojure.string/capitalize (:apellido_paterno params))
                    :apellido_materno (clojure.string/capitalize (:apellido_materno params))
                    :equipo           (clojure.string/capitalize (:equipo params))
                    :direccion        (capitalize-words (:direccion params))
                    :pais             (clojure.string/capitalize (:pais params))
                    :ciudad           (clojure.string/capitalize (:ciudad params))
